...
export const caseStudy = {
  ...
  summary: [
    'In recent studies, report generation was a recurring theme expressed by IT leaders to build custom dashboards and export large sets of data.',
    'In phase three of the BD Platform development, our product roadmap included a feature to allow customers to build their own custom dashboards and export custom sets of data.',
  ],
  logo,
  image: { src: imageHero },
  date: '2024-11',
